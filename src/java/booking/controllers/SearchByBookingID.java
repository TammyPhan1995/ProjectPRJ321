 ...
 * @author Tammy Phan
 */
public class SearchByBookingID extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
             ...
             List<BookingDetailDTO> result = dao.findByBookingId(search);
             request.setAttribute("INFO", result);
        } catch (Exception e) {
            log("ERROR AT searchByTourTitleController: " +e.getMessage());
        }finally{
