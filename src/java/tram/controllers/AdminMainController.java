...
public class AdminMainController extends HttpServlet {
    ...
    private final static String USER_MANAGE = "AccountController";
    private final static String TOUR_MANAGE = "TourController";
    private final static String BOOKING_MANAGE = "BookingController";
    private final static String PROMOTION_MANAGE = "PromotionController";
